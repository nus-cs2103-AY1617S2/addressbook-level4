...
is given in the [`Logic.java`](../src/main/java/seedu/description/logic/Logic.java)
...
The [`StringUtilTest.java`](../src/test/java/seedu/description/commons/util/StringUtilTest.java) class gives some examples
...
[`StringUtil.java`](../src/main/java/seedu/description/commons/util/StringUtil.java) class.
...
Consider the [`StorageManagerTest.java`](../src/test/java/seedu/description/storage/StorageManagerTest.java) class.
...
Compare the above with [`LogicManagerTest`](../src/test/java/seedu/description/logic/LogicManagerTest.java).
...
public void execute_add_invalidArgsFormat() throws Exception {
    ...
    assertCommandBehavior("add Valid Name 12345 e/valid@deadline.butNoPhonePrefix a/valid, description", expectedMessage);
    assertCommandBehavior("add Valid Name p/12345 valid@deadline.butNoPrefix a/valid, description", expectedMessage);
    ...
}
```
...
* **Singleton Pattern** : [`EventsCenter.java`](../src/main/java/seedu/description/commons/core/EventsCenter.java) is
  Singleton class. Its single instance can be accessed using the `EventsCenter.getInsance()` method.
* **Facade Pattern** : [`StorageManager.java`](../src/main/java/seedu/description/storage/StorageManager.java) is
  ...
  Facade class.
* **Command Pattern** : The [`Command.java`](../src/main/java/seedu/description/logic/commands/Command.java) and its
...
* **MVC Pattern** :
  ...
  * Sub classes of [`UiPart`](../src/main/java/seedu/description/ui/UiPart.java) (e.g. `PersonListPanel` )
