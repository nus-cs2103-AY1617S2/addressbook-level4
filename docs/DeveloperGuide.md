...
> 1b1. To-do list returns â€˜No task has been found.â€™ <br>
> Use case ends <br>
...
>1b1. To-do list returns â€˜No tags has been found.â€™ <br>
> Use case ends

<br>
...
1b. To-do list does not found any tags
> 1b1. To-do list returns â€˜No reminder has been found.â€™ <br>
> Use case ends
...
4. To-do list do the commands accordingly and displays â€˜operation doneâ€™ on UI
Use case ends
...
2. To-do list set the reminder and displays â€˜operation doneâ€™ on UI
Use case ends
...
2. To-do created the tag or added the tag and displays â€˜operation doneâ€™ on UI
Use case ends
...
2. To-do list undoes the last operation and displays â€˜operation doneâ€™ on UI.
...
>1a1. To-do list shows â€˜no previous operation foundâ€™<br>
> Use case ends
