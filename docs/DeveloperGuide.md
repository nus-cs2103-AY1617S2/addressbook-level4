...
3. [Design](#3-design)
	...
	3.2. [User Interface](#3.2-user-interface)
	3.3. [Logic](#3.3-logic)
	3.4. [Model](#3.4-model)
	3.5. [Storage](#3.5-storage)
...
T�che is an application meant for people who store, retrieve and edit their to-do tasks frequently. Our target audience is also people who prefer typing on the keyboard over the mouse. Hence, primary input for the application will be command-driven and using the Command Line Interface (CLI).  
