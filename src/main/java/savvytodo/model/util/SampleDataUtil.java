...
public class SampleDataUtil {
    public static Task[] getSampleTasks() {
        try {
            return new Task[] {
                    new Task(new Name("Alex Yeoh"), new Priority("low"), new Description("alexyeoh@gmail.com"),
                            new Address("Blk 30 Geylang Street 29, #06-40"), new UniqueCategoryList("friends")),
                    new Task(new Name("Bernice Yu"), new Priority("low"), new Description("berniceyu@gmail.com"),
                            new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                            new UniqueCategoryList("colleagues", "friends")),
                    new Task(new Name("Charlotte Oliveiro"), new Priority("low"),
                            new Description("charlotte@yahoo.com"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                            new UniqueCategoryList("neighbours")),
                    new Task(new Name("David Li"), new Priority("low"), new Description("lidavid@google.com"),
                            new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                            new UniqueCategoryList("family")),
                    new Task(new Name("Irfan Ibrahim"), new Priority("low"), new Description("irfan@outlook.com"),
                            new Address("Blk 47 Tampines Street 20, #17-35"), new UniqueCategoryList("classmates")),
                    new Task(new Name("Roy Balakrishnan"), new Priority("low"), new Description("royb@gmail.com"),
