        ...
        try {
            return new Task[] {
                ...
                new Task(new Name("David Li BDay"), new Priority("low"), new Description("6pm, rmb to buy present"),
                            new Address("Blk 436 Botanic Gardens Street 26, #16-43"), new UniqueCategoryList("family")),
                new Task(new Name("Driving lesson"), new Priority("medium"),
                            new Description("Bring PDL and wear shoes"), new Address("Ubi Crescent"),
                            new UniqueCategoryList("Driving")),
