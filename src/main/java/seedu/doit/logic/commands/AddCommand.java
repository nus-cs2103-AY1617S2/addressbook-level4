...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a task to the Task manager. "
            + "Parameters: TASK NAME p/PRIORITY s/START DATE&TIME e/END DATE&TIME d/ADDITIONAL DESCRIPTION [t/TAG]...\n"
            + "Example: " + COMMAND_WORD
            + " CS3230 Assignment1 p/high e/tomorrow 23:59 d/Prove bubble sort A t/CS3230\n" + COMMAND_WORD
            + " Hackathon p/med s/next monday 9am e/next tuesday d/create chatbot  t/hackathon\n" + COMMAND_WORD
            + " Food p/low d/for myself t/secret";
    ...
    public CommandResult execute() throws CommandException {
        ...
        try {
            ...
            EventsCenter.getInstance()
                    .post(new JumpToListRequestEvent(this.model.getFilteredTaskList().indexOf(this.toAdd)));
