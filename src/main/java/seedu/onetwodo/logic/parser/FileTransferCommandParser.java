...
//@@author A0139343E
/**
 * Parses input arguments and creates a new object related to file transfer File
 * transfer objects include save to, export and import
 */
public class FileTransferCommandParser {
    ...
    protected boolean isValidPath(String args) {
        return args.length() > XML_EXTENSION.length() && isXmlFormat(args);
    }

    // @@author A0139343E-unused
    /*
     * protected boolean hasInvalidName(String args) { String subString =
     * args.substring(0, args.length() - 4); Pattern pattern =
     * Pattern.compile("INVALID_FILE_NAME_REGEX"); Matcher matcher =
     * pattern.matcher(subString); return matcher.find(); }
     */
}
