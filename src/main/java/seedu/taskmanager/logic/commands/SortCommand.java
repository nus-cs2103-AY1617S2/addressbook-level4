...
public class SortCommand extends Command{
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Sorts tasks by either startdate or enddate in the task manager. "
            + "Examples: " + COMMAND_WORD + " s/ OR " + COMMAND_WORD + " e/.";
    ...
    /**
     * @param sortCriterion the criterion to sort tasks by
     */
