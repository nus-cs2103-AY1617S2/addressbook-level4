 ...
 * e.g. {@code some preamble text ON today FROM 0930TO1030 BY 1730} where
 * prefixes are {@code ON TO FROM BY}.<br>
 ...
 * {@code TO in 0930TO1030} in the above example<br>
 * 4. An argument may be repeated and all its values will be accumulated e.g.
 * the value of {@code /t} in the above example. (This function does not exist
 * yet) <br>
 */
public class ArgumentTokenizer {
    ...
    private List<PrefixPosition> findLastPrefixPositions(String argsString, Prefix prefix) {
        ...
        /*
         * int argumentStart = argsString.indexOf(prefix.getPrefix()); while
         * (argumentStart != -1) { PrefixPosition extendedPrefix = new
         * PrefixPosition(prefix, argumentStart); positions.add(extendedPrefix);
