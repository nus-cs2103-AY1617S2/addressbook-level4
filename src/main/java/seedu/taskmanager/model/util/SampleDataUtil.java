    ...
    public static Task[] getSampleTasks() {
        try {
            return new Task[] {
                ...
                new Task(new TaskName("Sign up for energy conference"), 
                        new StartDate("EMPTY_FIELD"), new StartTime("EMPTY_FIELD"),new EndDate("30/03/17"),
                        new EndTime("1300"), Boolean.FALSE,new UniqueCategoryList("NUS", "Low")),
