...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a task to TaskBoss. "
            + "Parameters: NAME p/PHONE e/EMAIL i/INFORMATION  [t/TAG]...\n"
            + "Example: " + COMMAND_WORD
            + " John Doe p/98765432 e/johnd@gmail.com i/311, Clementi Ave 2, #02-25 t/friends t/owesMoney";
     ...
     */
    public AddCommand(String name, String phone, String email, String information, Set<String> tags)
