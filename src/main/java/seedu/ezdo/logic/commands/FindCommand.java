...
/**
 * Finds and lists all tasks in ezDo whose name contains any of the argument keywords.
...
public class FindCommand extends Command {
    ...
    public FindCommand(Set<String> keywords, Optional<Priority> priorityToMatch,
                       Optional<TaskDate> startDateToMatch, Optional<TaskDate> dueDateToMatch, Set<String> tagsToMatch) {
