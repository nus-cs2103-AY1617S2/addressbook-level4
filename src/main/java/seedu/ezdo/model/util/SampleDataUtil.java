...
public class SampleDataUtil {
    public static Task[] getSampleTasks() {
        try {
            return new Task[] {
                new Task(new Name("Buy one cherry"), new Priority("1111"), new Email("1alexyeoh@gmail.com"),
                    new StartDate("Blk 130 Geylang Street 29, #06-40"),
                    new UniqueTagList("groceries")),
                new Task(new Name("Study for two midterms"), new Priority("2222"), new Email("2berniceyu@gmail.com"),
                    new StartDate("Blk 230 Lorong 3 Serangoon Gardens, #07-18"),
                    new UniqueTagList("school", "exams")),
                new Task(new Name("Buy ps three"), new Priority("3333"), new Email("3charlotte@yahoo.com"),
                    new StartDate("Blk 311 Ang Mo Kio Street 74, #11-04"),
                    new UniqueTagList("personal")),
                new Task(new Name("Visit four neighbours"), new Priority("4444"), new Email("4lidavid@google.com"),
                    new StartDate("Blk 436 Serangoon Gardens Street 26, #16-43"),
                    new UniqueTagList("personal")),
                new Task(new Name("Prepare for five finals"), new Priority("5555"), new Email("5irfan@outlook.com"),
                    new StartDate("Blk 547 Tampines Street 20, #17-35"),
                    new UniqueTagList("school", "exams")),
                new Task(new Name("Prepare six presentations"), new Priority("6666"), new Email("6royb@gmail.com"),
