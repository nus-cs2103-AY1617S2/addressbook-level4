...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a task to the Task Manager. "
            + "Parameters: TITLE st/STARTING_DATETIME et/ENDING_DATETIME l/LOCATION [t/TAG]...\n"
            + "Example: " + COMMAND_WORD
            + " Meeting 1 st/2017-04-01T10:16:30 et/2017-04-01T10:17:30 l/311, Clementi Ave 2, #02-25 t/friends";
