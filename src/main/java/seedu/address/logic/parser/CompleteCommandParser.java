...
import seedu.address.logic.commands.CompleteCommand.EditTaskDescriptor;
...
public class CompleteCommandParser {
    ...
    public Command parse(String argsOriginal) {
        ...
        if (!editTaskDescriptor.isAnyFieldEdited()) {
            return new IncorrectCommand(CompleteCommand.MESSAGE_NOT_EDITED);
        }

        return new CompleteCommand(index.get(), editTaskDescriptor);
    }
