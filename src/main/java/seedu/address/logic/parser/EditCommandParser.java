...
public class EditCommandParser {
    ...
    public Command parse(String args) {
        ...
        try {
            ...
            editPersonDescriptor.setPhone(ParserUtil.parseDate(argsTokenizer.getValue(PREFIX_DATE)));
            editPersonDescriptor.setEmail(ParserUtil.parseRemark(argsTokenizer.getValue(PREFIX_REMARK)));
