...
public class EditCommandParser {
    ...
    public Command parse(String args) {
        ...
        try {
            ...
            editPersonDescriptor.setEmail(ParserUtil.parseEmail(argsTokenizer.getValue(PREFIX_PRIORITY_LEVEL)));
            editPersonDescriptor.setAddress(ParserUtil.parseAddress(argsTokenizer.getValue(PREFIX_ANY_INFO)));
