...
public class EditCommandParser {
    ...
    public Command parse(String args) {
        ...
        try {
            ...
            editPersonDescriptor.setPriority(ParserUtil.parsePhone(argsTokenizer.getValue(PREFIX_PHONE)));
            editPersonDescriptor.setStatus(ParserUtil.parseEmail(argsTokenizer.getValue(PREFIX_EMAIL)));
            editPersonDescriptor.setNote(ParserUtil.parseAddress(argsTokenizer.getValue(PREFIX_ADDRESS)));
