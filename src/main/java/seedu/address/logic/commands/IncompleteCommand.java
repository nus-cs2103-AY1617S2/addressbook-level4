...
public class IncompleteCommand extends Command {
    ...
    public static final String MESSAGE_EDIT_PERSON_SUCCESS = "Incomplete Task: %1$s";
     ...
     */
    public IncompleteCommand(int filteredTaskListIndex, EditTaskDescriptor editTaskDescriptor) {
    ...
    public CommandResult execute() throws CommandException {
        ...
        String targetList = "non-floating";
        try {
            //change targetList to accommodate floatingTaskList in the future here
    ...
    private static Task createEditedTask(ReadOnlyTask taskToEdit,
        ...
        return new Task(updatedTitle, updatedDeadline, updatedPriority, updatedInstruction, updatedTags);
    }
    ...
    public static class EditTaskDescriptor {
        ...
        public void setDeadline(Optional<Deadline> date) {
            assert date != null;
            this.date = date;
        }
