...
public class MainWindow extends UiPart<Region> {
	...
	void fillInnerParts() {
		this.browserPanel = new BrowserPanel(this.browserPlaceholder);
		this.taskListPanel = new TaskListPanel(getTaskListPlaceholder(), this.logic.getFilteredTaskList());
		new ResultDisplay(getResultDisplayPlaceholder());
		new StatusBarFooter(getStatusbarPlaceholder(), this.config.getAddressBookFilePath());
	...
	void loadTaskPage(ReadOnlyTask task) {
		this.browserPanel.loadTaskPage(task);
	}
