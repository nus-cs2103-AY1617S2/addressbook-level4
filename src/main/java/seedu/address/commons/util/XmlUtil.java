...
public class XmlUtil {
   ...
   *           Thrown if the file is empty or does not have the correct format.
   */
  @SuppressWarnings("unchecked")
  public static <T> T getDataFromFile(File file, Class<T> classToConvert) throws FileNotFoundException, JAXBException {
   ...
   *           Thrown if the file is missing.
   * @throws JAXBException
   *           Thrown if there is an error during converting the data into xml
