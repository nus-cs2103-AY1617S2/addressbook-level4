...
public class TaskManager implements ReadOnlyTaskManager {
	...
	public void resetData(ReadOnlyTaskManager newData) {
		...
		syncMasterTagListWith(this.tasks);
	}
	...
	public void updateTask(int index, ReadOnlyTask editedReadOnlyTask) throws UniqueTaskList.DuplicateTaskException {
		...
		// in the task list.
		this.tasks.updateTask(index, editedTask);
	}
	...
	private void syncMasterTagListWith(Task task) {
		...
		this.tags.mergeFrom(taskTags);

		// Create map with values = tag object references in the master list
		// used for checking task tag references
		final Map<Tag, Tag> masterTagObjects = new HashMap<>();
		this.tags.forEach(tag -> masterTagObjects.put(tag, tag));
	...
	public ObservableList<ReadOnlyTask> getTaskList() {
		return new UnmodifiableObservableList<>(this.tasks.asObservableList());
	}

	@Override
	public ObservableList<Tag> getTagList() {
		return new UnmodifiableObservableList<>(this.tags.asObservableList());
	}
	...
	public int hashCode() {
		...
		// your own
		return Objects.hash(this.tasks, this.tags);
	}
}
