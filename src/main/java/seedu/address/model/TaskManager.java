...
public class TaskManager implements ReadOnlyTaskManager {
   ...
   * updates {@link #tags} with any new tags found, and updates the Tag objects
   * in the task to point to those in {@link #tags}.
   *
   ...
   * {@code editedReadOnlyTask}. {@code TaskManager}'s tag list will be updated
   * with the tags of {@code editedReadOnlyTask}.
   * @see #syncMasterTagListWith(Task)
   *
   * @throws DuplicateTaskException
   *           if updating the task's details causes the task to be equivalent
   *           to another existing task in the list.
  ...
  public void updateTask(int index, ReadOnlyTask editedReadOnlyTask) throws UniqueTaskList.DuplicateTaskException {
    ...
    // fails.
    // This can cause the tags master list to have additional tags that are not
    // tagged to any task
    // in the task list.
  ...
  private void syncMasterTagListWith(Task task) {
    ...
    // Rebuild the list of task tags to point to the relevant tags in the master
    // tag list.
