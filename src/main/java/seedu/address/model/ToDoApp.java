 ...
 */
public class ToDoApp implements ReadOnlyToDoApp {
     ...
     */
    public ToDoApp(ReadOnlyToDoApp toBeCopied) {
        this();
...
//// util methods
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof ToDoApp // instanceof handles nulls
                && this.tasks.equals(((ToDoApp) other).tasks)
                && this.tags.equalsOrderInsensitive(((ToDoApp) other).tags));
    }
