		...
		try {
			return new Task[] {
					new Task(new Name("Alex Yeoh"), new Priority("87438807"), new Deadline("alexyeoh@gmail.com"),
							new Description("Blk 30 Geylang Street 29, #06-40"), new UniqueTagList("friends")),
					...
					new Task(new Name("Charlotte Oliveiro"), new Priority("93210283"),
							new Deadline("charlotte@yahoo.com"), new Description("Blk 11 Ang Mo Kio Street 74, #11-04"),
					...
					new Task(new Name("Irfan Ibrahim"), new Priority("92492021"), new Deadline("irfan@outlook.com"),
							new Description("Blk 47 Tampines Street 20, #17-35"), new UniqueTagList("classmates")),
					new Task(new Name("Roy Balakrishnan"), new Priority("92624417"), new Deadline("royb@gmail.com"),
							new Description("Blk 45 Aljunied Street 85, #11-31"), new UniqueTagList("colleagues")) };
