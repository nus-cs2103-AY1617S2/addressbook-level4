...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        try {
            return new Person[] {
                new Person(new Name("study SE"), new Date("12.12"), new StartDate("09.01"),
                            new Email("alexyeoh@gmail.com"), new Group("learning"), new UniqueTagList("undone")),
                new Person(new Name("watch Beauty and Beast"), new Date("01.01"), new StartDate("00.00"),
                            new Email("berniceyu@gmail.com"), new Group("relax"),
                            new UniqueTagList("undone", "important")),
                new Person(new Name("do tutorial"), new Date("03.11"), new StartDate("00.00"),
                            new Email("charlotte@yahoo.com"), new Group("learning"), new UniqueTagList("undone")),
                new Person(new Name("review the lesson"), new Date("03.21"), new StartDate("00.00"),
                            new Email("lidavid@google.com"), new Group("learning"), new UniqueTagList("undone")),
                new Person(new Name("read books"), new Date("03.31"), new StartDate("00.00"),
                            new Email("irfan@outlook.com"), new Group("leisure time"), new UniqueTagList("undone")),
                new Person(new Name("painting"), new Date("03.06"), new StartDate("00.00"),
