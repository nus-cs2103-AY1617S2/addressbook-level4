...
public class SetCommand extends Command {
    ...
    //@@author A0130979U
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Set email and password to login to the Google Calendar. "
    ...
    public static final String MESSAGE_INVALID_EMAIL = "Emails should be 2 alphanumeric/period strings separated by '@'";       
