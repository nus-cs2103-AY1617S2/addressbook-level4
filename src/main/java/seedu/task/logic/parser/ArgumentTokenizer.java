...
public class ArgumentTokenizer {
    ...
    /**
     * Returns the preamble (text before the first valid prefix), if any. Leading/trailing spaces
     * will be trimmed. If the string before the first prefix is empty, Optional.empty() will be
     * returned.
     */
