 ...
 * e.g. {@code some preamble text /t 11.00/dToday /t 12.00 /k /m July} where prefixes are
 * {@code /t /d /k /m}.<br>
 * 1. An argument's value can be an empty string e.g. the value of {@code /k} in the above
 * example.<br>
 * 2. Leading and trailing whitespaces of an argument value will be discarded.<br>
 * 3. A prefix need not have leading and trailing spaces e.g. the {@code /d in 11.00/dToday} in the
 * above example<br>
...
public class ArgumentTokenizer {
  ...
  /**
   * Returns the preamble (text before the first valid prefix), if any. Leading/trailing spaces will
   * be trimmed. If the string before the first prefix is empty, Optional.empty() will be returned.
   */
  ...
  private void extractArguments(String argsString, List<PrefixPosition> prefixPositions) {
    ...
    prefixPositions
        .sort((prefix1, prefix2) -> prefix1.getStartPosition() - prefix2.getStartPosition());
  ...
  /**
   * Returns the trimmed value of the argument specified by {@code currentPrefixPosition}. The end
   * position of the value is determined by {@code nextPrefixPosition}
   */
