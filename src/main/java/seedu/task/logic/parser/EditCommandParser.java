...
public class EditCommandParser {
  ...
  public Command parse(String args) {
    ...
    try {
      ...
      editPersonDescriptor
          .setTaskDescription(ParserUtil.parseString(argsTokenizer.getValue(PREFIX_DESCRIPTION)));
      editPersonDescriptor
  ...
  /**
   * Parses {@code Collection<String> tags} into an {@code Optional<UniqueTagList>} if {@code tags}
   * is non-empty. If {@code tags} contain only one element which is an empty string, it will be
   * parsed into a {@code Optional<UniqueTagList>} containing zero tags.
   */
