...
public class EditCommandParser {
    ...
    public Command parse(String args) {
        assert args != null;
        ArgumentTokenizer argsTokenizer = new ArgumentTokenizer(PREFIX_DATE, PREFIX_START_TIME,
        ...
        try {
            ...
            editPersonDescriptor
                    .setTaskDate(ParserUtil.parseDate(argsTokenizer.getValue(PREFIX_DATE)));
            editPersonDescriptor.setTaskStartTime(
                    ParserUtil.parseTime(argsTokenizer.getValue(PREFIX_START_TIME)));
            editPersonDescriptor
                    .setTaskEndTime(ParserUtil.parseTime(argsTokenizer.getValue(PREFIX_END_TIME)));
    ...
    /**
     * Parses {@code Collection<String> tags} into an {@code Optional<UniqueTagList>} if
     * {@code tags} is non-empty. If {@code tags} contain only one element which is an empty string,
     * it will be parsed into a {@code Optional<UniqueTagList>} containing zero tags.
     */
