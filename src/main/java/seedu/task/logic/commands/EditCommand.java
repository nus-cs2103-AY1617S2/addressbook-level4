...
public class EditCommand extends Command {
    ...
    private static Task createEditedTask(ReadOnlyTask taskToEdit,
        ...
        return new Task(updatedTaskName, updatedDate, updatedStartTime, updatedEndTime, updatedDescription, updatedTags);
    }
    ...
    public static class EditTaskDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyPresent(this.taskName, this.taskDate, this.taskStartTime, this.taskEndTime, this.taskDescription, this.tags);
        }
