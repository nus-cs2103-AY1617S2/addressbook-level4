...
public class EditCommand extends Command {
    ...
    private static Task createEditedTask(ReadOnlyTask taskToEdit,
        ...
        TaskName updatedTaskName = editTaskDescriptor.getTaskName()
                .orElseGet(taskToEdit::getTaskName);
        TaskDate updatedDate = editTaskDescriptor.getTaskDate().orElseGet(taskToEdit::getTaskDate);
        TaskTime updatedStartTime = editTaskDescriptor.getTaskStartTime()
                .orElseGet(taskToEdit::getTaskStartTime);
        TaskTime updatedEndTime = editTaskDescriptor.getTaskEndTime()
                .orElseGet(taskToEdit::getTaskEndTime);
        String updatedDescription = editTaskDescriptor.getTaskDescription()
                .orElseGet(taskToEdit::getTaskDescription);
        TaskStatus remainStatus = new TaskStatus("Ongoing");
        UniqueTagList updatedTags = editTaskDescriptor.getTags().orElseGet(taskToEdit::getTags);

        return new Task(updatedTaskName, updatedDate, updatedStartTime, updatedEndTime,
                updatedDescription, remainStatus, updatedTags);
    ...
    public static class EditTaskDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyPresent(this.taskName, this.taskDate, this.taskStartTime,
                    this.taskEndTime, this.taskDescription, this.tags);
        }
