...
public class TaskManager implements ReadOnlyTaskManager {
    ...
    /**
     * Adds a task to the task manager. Also checks the new task's tags and updates {@link #tags}
     * with any new tags found, and updates the Tag objects in the task to point to those in
     * {@link #tags}.
     *
     * @throws UniqueTaskList.DuplicateTaskException
    ...
    /**
     * Ensures that every tag in these tasks: - exists in the master list {@link #tags} - points to
    ...
    public String toString() {
        return tasks.asObservableList().size() + " tasks, " + tags.asObservableList().size()
                + " tags";
        // TODO: refine later
    }
