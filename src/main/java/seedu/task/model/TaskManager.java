...
/**
 * Wraps all data at the task-manager level Duplicates are not allowed (by .equals comparison)
 */
public class TaskManager implements ReadOnlyTaskManager {
  ...
  /**
   * Adds a task to the task manager. Also checks the new task's tags and updates {@link #tags} with
   * any new tags found, and updates the Tag objects in the task to point to those in {@link #tags}.
   *
   * @throws UniqueTaskList.DuplicateTaskException
   ...
   *           if updating the task's details causes the task to be equivalent to another existing
   *           task in the list.
  ...
  /**
   * Ensures that every tag in these tasks: - exists in the master list {@link #tags} - points to a
   * Tag object in the master list
   * 
   * @see #syncMasterTagListWith(Task)
   */
