	...
	try {
	    return new Task[] {
		    new Task(new TaskName("Buy apple juice"), new TaskDate("010117"), new TaskTime("0800"),
			    new TaskTime("1000"), new String("Look out for lucky draws."),new TaskStatus("Ongoing"), new UniqueTagList()),
		    new Task(new TaskName("Buy blueberry juice"), new TaskDate("020117"), new TaskTime("0900"),
			    new TaskTime("1001"), new String("Look out for lucky dips."),new TaskStatus("Ongoing"), new UniqueTagList()),
		    new Task(new TaskName("Buy coke"), new TaskDate("030117"), new TaskTime("0930"),
			    new TaskTime("1002"), new String("Look out for traffic."), new TaskStatus("Ongoing"), new UniqueTagList()),
		    new Task(new TaskName("Buy isotonic drinks"), new TaskDate("040117"), new TaskTime("1000"),
			    new TaskTime("1100"), new String("Look out for promotions."), new TaskStatus("Ongoing"), new UniqueTagList()),
		    new Task(new TaskName("Buy orange juice"), new TaskDate("050117"), new TaskTime("1010"),
			    new TaskTime("1100"), new String("Look out for sweets along the way."), new TaskStatus("Ongoing"),
			    new UniqueTagList()) };
