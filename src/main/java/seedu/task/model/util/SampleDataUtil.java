    ...
    try {
      return new Task[] {
          ...
          new Task(new TaskName("Buy blueberry juice"), new TaskDate("020117"),
              new TaskTime("0900"), new TaskTime("1001"), new String("Look out for lucky dips."),
              new TaskStatus("Ongoing"), new UniqueTagList()),
          ...
          new Task(new TaskName("Buy isotonic drinks"), new TaskDate("040117"),
              new TaskTime("1000"), new TaskTime("1100"), new String("Look out for promotions."),
              new TaskStatus("Ongoing"), new UniqueTagList()),
          ...
          new Task(new TaskName("Pick Jasmine from work"), new TaskDate("050117"),
              new TaskTime("1800"), new TaskTime("1830"), new String("Take note of traffic jams."),
              new TaskStatus("Ongoing"), new UniqueTagList()),
          ...
          new Task(new TaskName("Pick up takeaways from hawker centre"), new TaskDate("050117"),
              new TaskTime("2000"), new TaskTime("2020"),
              new String("Call in advance for food order."), new TaskStatus("Ongoing"),
              new UniqueTagList()),
