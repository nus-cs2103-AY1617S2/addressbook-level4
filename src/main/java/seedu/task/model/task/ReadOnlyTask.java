...
/**
 * A read-only immutable interface for a Task in the task manager. Implementations should guarantee:
 * details are present and not null, field values are validated.
 */
public interface ReadOnlyTask {
  ...
  /**
   * The returned TagList is a deep copy of the internal TagList, changes on the returned list will
   * not affect the task's internal tags.
   */
  ...
  default boolean isSameStateAs(ReadOnlyTask other) {
    return other == this // short circuit if same object
        || (other != null // this is first to avoid NPE below
            ...
            && other.getTaskStatus() != null && other.getTaskStatus().equals(this.getTaskStatus());
  }
