...
public class RandomTaskGenerator {
	...
	private static final String[] CLASS_LIST = {"MATH", "NETWORKING", "PSYCHOLOGY", "CRYPTOGRAPHY", "PHILOSOPHY", "FAT STUDIES", "CHINESE", "PHYSICAL EDUCATION", "PHYSICS", "HEAT TRANSFER"};
	private static final String[] BUILDING_LIST = {"Love", "Woodruff", "MRDC", "CRC", "Klaus", "Knight", "Howey"};
	private static final String[] THINGS_TO_BUY = {"peanut butter", "milk", "soy milk", "snacks", "fruit", "bananas", "century eggs", "isotonic"};
	private static final String[] WORKOUT_DAYS = {"Chest day", "Back day", "Leg day", "Secondary chest day", "arm day"};
	public static Task generateTask() {
		...
		while (!generated) {
			try {
				...
				Task retTask = new Task(taskName, taskDate, taskStartTime, taskEndTime, taskDescription, new TaskStatus(TaskStatus.MESSAGE_INCOMPLETE));
				return retTask;
			} catch (Exception e) {
				//Task generation had an error, probably from start time being before end time;
			}
		}
		//unreachable
		return null;
