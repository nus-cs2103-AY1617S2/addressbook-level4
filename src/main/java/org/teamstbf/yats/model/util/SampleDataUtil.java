        ...
        try {
            return new Event[] {
                    ...
                    new Event(new Title("Grocery Shopping"), new Location("FoodCourt"),
                            ...
                            new Description("Buy some food"), new UniqueTagList("necessitires"), new IsDone(), false,
                            new Recurrence()),
                    ...
                    new Event(new Title("Inductive Reasoning Based Phillosophy"), new Location("Home"),
                            ...
                            new UniqueTagList("home", "books", "reading", "armaggedon"), new IsDone(), false,
                            new Recurrence()),
                    ...
                    new Event(new Title("Replication based on computer dynamic memory"),
                            ...
                            new Description(""), new UniqueTagList("Ryzen", "Vega"), new IsDone(), false,
                            new Recurrence()),
