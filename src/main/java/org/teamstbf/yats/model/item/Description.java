...
public class Description {
    ...
    public static final String MESSAGE_DESCRIPTION_CONSTRAINTS = "Task description can take any values, "
            + "but can only be 1000 characters in length. It can be left blank.";
