...
public class TaskManager implements ReadOnlyTaskManager {
	...
	public void setTasks(List<? extends ReadOnlyEvent> tasks) throws UniqueEventList.DuplicateEventException {
	 ...
	 *             if updating the task's details causes the person to be
	 *             equivalent to another existing task in the list.
	 * @throws IndexOutOfBoundsException
	 *             if {@code index} < 0 or >= the size of the list.
	 */
	public void updateEvent(int index, Event editedReadOnlyEvent) throws UniqueEventList.DuplicateEventException {
