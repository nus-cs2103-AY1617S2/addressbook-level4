...
public class IndexTokenizerTest {
    ...
    public void splitIndexes_obtainSingleIndex() {
        List<Integer> actual = IndexTokenizer.splitIndexes(" 3  ", 8);
    ...
    public void splitIndexes_obtainIndexesFromStartIndexToEndIndex() {
        List<Integer> actual = IndexTokenizer.splitIndexes("3-5", 8);
    ...
    public void splitIndexes_obtainIndexesFromPoorlyFormattedStringIndexes() {
        List<Integer> actual = IndexTokenizer.splitIndexes("1-2  ,    3-   4   5  -6   , 7   -      8", 8);
    ...
    public void splitIndexes_obtainIndexesFromAssortedIndexes() {
        List<Integer> actual = IndexTokenizer.splitIndexes("1 3,  7", 8);
    ...
    public void splitIndexes_obtainIndexesFromAssortedUnorderedIndexes() {
        List<Integer> actual = IndexTokenizer.splitIndexes("3, 2, 8, 5-7", 8);
    ...
    public void splitIndexes_obtainIndexesComplexStringIndexes() {
        List<Integer> actual = IndexTokenizer.splitIndexes("- 3, 5, 7 - 12", 8);
    ...
    public void splitIndexes_withInvalidIndex1() {
        List<Integer> actual = IndexTokenizer.splitIndexes("banana", 8);
    ...
    public void splitIndexes_withInvalidIndex2() {
        List<Integer> actual = IndexTokenizer.splitIndexes("-3 banana 5", 8);
        List<Integer> expected = Arrays.asList(1, 2, 3);
        assertTrue(actual.equals(expected));
    }
    ...
    public void splitIndexes_withInvalidIndex3() {
        List<Integer> actual = IndexTokenizer.splitIndexes("-3 5 banana", 8);
