...
import static seedu.tasklist.commons.core.Messages.MESSAGE_INVALID_TASK_DISPLAYED_INDEX;
...
public class LogicManagerTest {
     ...
     *      - the internal address book data are same as those in the {@code expectedTaskList} <br>
