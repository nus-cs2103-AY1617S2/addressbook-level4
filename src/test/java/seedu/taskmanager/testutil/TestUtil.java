...
public class TestUtil {
    ...
    private static Task[] getSampleTaskData() {
        try {
            return new Task[]{
                new Task(new Title("Visit Alex Yeoh"),
                        Optional.ofNullable(new StartDate("01/11/2017")),
                        ...
                        new UniqueTagList()),
                new Task(new Title("Borrow Pencils"),
                        Optional.ofNullable(new StartDate("04/03/2017")),
                        Optional.ofNullable(new EndDate("04/03/2017")),
                        Optional.ofNullable(new Description("Must be non-mechanical")),
                        new UniqueTagList()),
                new Task(new Title("Finish CS2103 testing"),
                        Optional.ofNullable(new StartDate("10/03/2017")),
                        Optional.ofNullable(new EndDate("15/03/2017")),
                        Optional.ofNullable(new Description("The best module eva")),
                        new UniqueTagList()),
                new Task(new Title("Buy Toothpick"),
                        Optional.ofNullable(new StartDate("20/05/2016")),
                        Optional.ofNullable(new EndDate("21/05/2017")),
                        Optional.ofNullable(new Description("Buy 1000pcs")),
                        new UniqueTagList()),
                new Task(new Title("Make baos for gathering"),
                        Optional.ofNullable(new StartDate("10/03/2017")),
                        Optional.ofNullable(new EndDate("20/03/2017")),
                        Optional.ofNullable(new Description("3 flavours: chocolate, red bean, and green bean")),
                        new UniqueTagList())
            };
