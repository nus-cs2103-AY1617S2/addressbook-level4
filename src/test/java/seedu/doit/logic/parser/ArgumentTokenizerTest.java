...
import seedu.doit.logic.parser.ArgumentTokenizer;
...
public class ArgumentTokenizerTest {
	...
	public void accessors_notTokenizedYet() {
		ArgumentTokenizer tokenizer = new ArgumentTokenizer(this.slashP);
		assertPreambleAbsent(tokenizer);
		assertArgumentAbsent(tokenizer, this.slashP);
	}
	...
	public void tokenize_oneArgument() {
		...
		assertArgumentPresent(tokenizer, this.slashP, "Argument value");
	...
	public void tokenize_multipleArguments() {
		ArgumentTokenizer tokenizer = new ArgumentTokenizer(this.slashP, this.dashT, this.hatQ);
		...
		assertArgumentPresent(tokenizer, this.slashP, "slashP value");
		assertArgumentPresent(tokenizer, this.dashT, "dashT-Value");
		assertArgumentAbsent(tokenizer, this.hatQ);
		...
		assertArgumentPresent(tokenizer, this.slashP, "slashP value");
		assertArgumentPresent(tokenizer, this.dashT, "dashT-Value");
		assertArgumentPresent(tokenizer, this.hatQ, "111");
		...
		String stringWithUnknownPrefix = this.unknownPrefix.getPrefix() + "some value";
		tokenizer.tokenize(stringWithUnknownPrefix);
		assertArgumentAbsent(tokenizer, this.unknownPrefix);
	...
	public void tokenize_multipleArgumentsWithRepeats() {
		...
		assertPreamblePresent(tokenizer, "SomePreambleString");
		assertArgumentPresent(tokenizer, this.slashP, "slashP value");
		assertArgumentPresent(tokenizer, this.dashT, "dashT-Value", "another dashT value", "");
		assertArgumentPresent(tokenizer, this.hatQ, "", "");
	}
