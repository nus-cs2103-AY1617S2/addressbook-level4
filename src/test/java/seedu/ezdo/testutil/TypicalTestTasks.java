...
public class TypicalTestTasks {
    ...
    public TypicalTestTasks() {
        try {
            ...
            carl = new TaskBuilder().withName("Carl Kurz").withPriority(1)
                    .withEmail("heinz@yahoo.com").withStartDate("wall street").build();
            daniel = new TaskBuilder().withName("Daniel Meier").withPriority(1)
                    .withEmail("cornelia@google.com").withStartDate("10th street").build();
            elle = new TaskBuilder().withName("Elle Meyer").withPriority(1)
                    .withEmail("werner@gmail.com").withStartDate("michegan ave").build();
            fiona = new TaskBuilder().withName("Fiona Kunz").withPriority(1)
                    .withEmail("lydia@gmail.com").withStartDate("little tokyo").build();
            george = new TaskBuilder().withName("George Best").withPriority(1)
            ...
            ida = new TaskBuilder().withName("Ida Mueller").withPriority(1)
