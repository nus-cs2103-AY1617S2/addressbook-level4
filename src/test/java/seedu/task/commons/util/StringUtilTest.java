...
public class StringUtilTest {
    ...
    /*
     * Invalid equivalence partitions for word: null, empty, multiple words Invalid equivalence
     * partitions for sentence: null The four test cases below test one invalid input at a time.
     */
    ...
    public void containsWordIgnoreCase_multipleWords_exceptionThrown() {
        assertExceptionThrown("typical sentence", "aaa BBB",
    ...
    /*
     * Valid equivalence partitions for word: - any word - word containing symbols/numbers - word
     * with leading/trailing spaces
     *
     * Valid equivalence partitions for sentence: - empty string - one word - multiple words -
     * sentence with extra spaces
     *
     * Possible scenarios returning true: - matches first word in sentence - last word in sentence -
     * middle word in sentence - matches multiple words
     *
     * Possible scenarios returning false: - query word matches part of a sentence word - sentence
     * word matches part of the query word
     *
