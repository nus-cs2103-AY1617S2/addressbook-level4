...
public class XmlUtilTest {
    ...
    public void getDataFromFile_validFile_validResult() throws Exception {
        XmlSerializableTaskList dataFromFile =
                XmlUtil.getDataFromFile(VALID_FILE, XmlSerializableTaskList.class);
        System.out.println(dataFromFile.getTaskList().size() + "" +  dataFromFile.getTagList().size());
    ...
    public void saveDataToFile_validFile_dataSaved() throws Exception {
        ...
        XmlSerializableTaskList dataFromFile =
                XmlUtil.getDataFromFile(TEMP_FILE, XmlSerializableTaskList.class);
