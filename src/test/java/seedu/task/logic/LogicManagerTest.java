...
public class LogicManagerTest {
  ...
  class TestDataHelper {
    ...
    Task adam() throws Exception {
      ...
      return new Task(taskName, taskDate, taskStartTime, taskEndTime, taskDescription, taskStatus,
          tags);
     ...
     * values guarantees the returned person will have the same state. Each unique seed will
     * generate a unique Person object.
     *
     * @param seed
    ...
    /**
     * Adds auto-generated Task objects to the given model @param model The model to which the Tasks
     * will be added
     */
    ...
    Task generateTaskWithName(String name) throws Exception {
      return new Task(new TaskName(name), new TaskDate("111111"), new TaskTime("1405"),
          new TaskTime("1408"), new String("This is some description."), new TaskStatus("Ongoing"),
          new UniqueTagList());
    }
    // @@author
  }
