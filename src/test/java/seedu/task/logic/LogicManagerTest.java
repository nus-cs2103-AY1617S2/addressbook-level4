...
public class LogicManagerTest {
    ...
    private void assertCommandSuccess(String inputCommand, String expectedMessage,
            ReadOnlyTaskList expectedAddressBook, List<? extends ReadOnlyTask> expectedShownList) {
    ...
    public void execute_add_invalidTaskData() {
        ...
        // assertCommandFailure("add Valid Name d/not_numbers s/valid@e.mail
        // e/valid, address",
        ...
        assertCommandFailure(
                "add Valid Name d/12345 s/01/01/1980 0000 e/01/01/1980 0000, address t/invalid_-[.tag",
     ...
     *
     * @param commandWord to test assuming it targets a single person in the
    ...
    public void execute_find_onlyMatchesFullWordsInNames() throws Exception {
        ...
        assertCommandSuccess("find KEY", Command.getMessageForPersonListShownSummary(expectedList.size()),
    ...
    public void execute_find_matchesIfAnyKeywordPresent() throws Exception {
        ...
        assertCommandSuccess("find key rAnDoM",
                Command.getMessageForPersonListShownSummary(expectedList.size()), expectedTaskList,
                expectedList);
    }
