package seedu.taskcrusher.logic;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertFalse;
import static org.junit.Assert.assertTrue;
import static seedu.taskcrusher.commons.core.Messages.MESSAGE_INVALID_COMMAND_FORMAT;
import static seedu.taskcrusher.commons.core.Messages.MESSAGE_INVALID_TASK_DISPLAYED_INDEX;
import static seedu.taskcrusher.commons.core.Messages.MESSAGE_UNKNOWN_COMMAND;
...
import seedu.taskcrusher.commons.events.ui.JumpToListRequestEvent;
import seedu.taskcrusher.commons.events.ui.ShowHelpRequestEvent;
import seedu.taskcrusher.logic.Logic;
import seedu.taskcrusher.logic.LogicManager;
import seedu.taskcrusher.logic.commands.AddCommand;
import seedu.taskcrusher.logic.commands.ClearCommand;
import seedu.taskcrusher.logic.commands.Command;
import seedu.taskcrusher.logic.commands.CommandResult;
import seedu.taskcrusher.logic.commands.DeleteCommand;
import seedu.taskcrusher.logic.commands.ExitCommand;
import seedu.taskcrusher.logic.commands.FindCommand;
import seedu.taskcrusher.logic.commands.HelpCommand;
import seedu.taskcrusher.logic.commands.ListCommand;
import seedu.taskcrusher.logic.commands.SelectCommand;
import seedu.taskcrusher.logic.commands.exceptions.CommandException;
import seedu.taskcrusher.model.Model;
import seedu.taskcrusher.model.ModelManager;
...
public class LogicManagerTest {
    ...
    private ReadOnlyUserInbox latestSavedAddressBook;
    private boolean helpShown;
    private int targetedJumpIndex;

    @Subscribe
    private void handleLocalModelChangedEvent(AddressBookChangedEvent abce) {
        latestSavedAddressBook = new UserInbox(abce.data);
    }
    ...
    public void execute_list_showsAllPersons() throws Exception {
        ...
        TestDataHelper helper = new TestDataHelper();
        UserInbox expectedAB = helper.generateAddressBook(2);
    ...
    public void execute_select_jumpsToCorrectPerson() throws Exception {
        ...
        UserInbox expectedAB = helper.generateAddressBook(threePersons);
    ...
    public void execute_find_onlyMatchesFullWordsInNames() throws Exception {
        ...
        UserInbox expectedAB = helper.generateAddressBook(fourPersons);
    ...
    class TestDataHelper {
         ...
         */
        UserInbox generateAddressBook(int numGenerated) throws Exception {
            UserInbox addressBook = new UserInbox();
         ...
         */
        UserInbox generateAddressBook(List<Task> persons) throws Exception {
            UserInbox addressBook = new UserInbox();
         ...
         */
        void addToAddressBook(UserInbox addressBook, int numGenerated) throws Exception {
         ...
         */
        void addToAddressBook(UserInbox addressBook, List<Task> personsToAdd) throws Exception {
