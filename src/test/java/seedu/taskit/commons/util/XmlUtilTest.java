package seedu.taskit.commons.util;
...
import seedu.taskit.commons.util.XmlUtil;
import seedu.taskit.model.TaskManager;
import seedu.taskit.storage.XmlSerializableAddressBook;
import seedu.taskit.testutil.AddressBookBuilder;
...
public class XmlUtilTest {
    ...
    private static final File VALID_FILE = new File(TEST_DATA_FOLDER + "validTaskIt.xml");
    private static final File TEMP_FILE = new File(TestUtil.getFilePathInSandboxFolder("tempTaskIt.xml"));
