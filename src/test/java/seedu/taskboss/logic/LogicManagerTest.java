...
public class LogicManagerTest {
    ...
    public void setUp() {
        ...
        latestSavedTaskBoss = new TaskBoss(model.getTaskBoss()); // last saved assumed to be up to date
        helpShown = false;
     ...
     * Also confirms that both the 'taskboss' and the 'last shown list' are as specified.
     * @see #assertCommandBehavior(boolean, String, String, ReadOnlyTaskBoss, List)
     */
     ...
     * Both the 'taskboss' and the 'last shown list' are verified to be unchanged.
     * @see #assertCommandBehavior(boolean, String, String, ReadOnlyTaskBoss, List)
     */
     ...
     *      - the internal TaskBoss data are same as those in the {@code expectedTaskBoss} <br>
    ...
    public void execute_add_invalidArgsFormat() {
        ...
        assertCommandFailure("add Valid Name 12345 a/valid,address", expectedMessage);
        assertCommandFailure("add Valid Name p/12345 a/valid, address", expectedMessage);
        assertCommandFailure("add Valid Name p/12345 valid, address", expectedMessage);
    }

    @Test
    public void execute_add_invalidTaskData() {
        assertCommandFailure("add []\\[;] p/12345 a/valid, address",
                Name.MESSAGE_NAME_CONSTRAINTS);
        assertCommandFailure("add Valid Name p/not_numbers a/valid, address",
                Phone.MESSAGE_PHONE_CONSTRAINTS);
        assertCommandFailure("add Valid Name p/12345 a/valid, address t/invalid_-[.tag",
    ...
    class TestDataHelper {
         ...
         * @param taskBoss The TaskBoss to which the Tasks will be added
         */
