...
public class LogicManagerTest {
	...
	private void handleLocalModelChangedEvent(TaskManagerChangedEvent abce) {
		this.latestSavedAddressBook = new TaskManager(abce.data);
	}
	...
	public void setUp() {
		...
		String tempAddressBookFile = this.saveFolder.getRoot().getPath() + "TempAddressBook.xml";
		String tempPreferencesFile = this.saveFolder.getRoot().getPath() + "TempPreferences.json";
		this.logic = new LogicManager(this.model, new StorageManager(tempAddressBookFile, tempPreferencesFile));
		EventsCenter.getInstance().registerHandler(this);

		this.latestSavedAddressBook = new TaskManager(this.model.getTaskManager()); // last
																					// saved
																					// assumed
																					// to
																					// be
	...
	private void assertCommandSuccess(String inputCommand, String expectedMessage,
			ReadOnlyTaskManager expectedAddressBook, List<? extends ReadOnlyTask> expectedShownList) {
	...
	private void assertCommandFailure(String inputCommand, String expectedMessage) {
		TaskManager expectedAddressBook = new TaskManager(this.model.getTaskManager());
	...
	private void assertCommandBehavior(boolean isCommandExceptionExpected, String inputCommand, String expectedMessage,
		...
		assertEquals(expectedAddressBook, this.model.getTaskManager());
		assertEquals(expectedAddressBook, this.latestSavedAddressBook);
	}
	...
	public void execute_add_invalidTaskData() {
		assertCommandFailure("add []\\[;] p/12 e/15-3-2020 d/valid t/address", Name.MESSAGE_NAME_CONSTRAINTS);
	}
	...
	public void execute_addDuplicate_notAllowed() throws Exception {
		...
		this.model.addTask(toBeAdded); // task already in internal address book
	...
	class TestDataHelper {
		...
		Task generateTask(int seed) throws Exception {
			return new Task(new Name("Task " + seed), new Priority("" + Math.abs(seed)), new Deadline(seed + "2359"),
		...
		Task generateTaskWithName(String name) throws Exception {
			return new Task(new Name(name), new Priority("1"), new Deadline("1@email"), new Description("House of 1"),
