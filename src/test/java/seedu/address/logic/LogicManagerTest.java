...
public class LogicManagerTest {
    ...
    private void assertIndexNotFoundBehaviorForCommand(String commandWord) throws Exception {
        ...
        TestDataHelper helper = new TestDataHelper();
        List<ToDo> personList = helper.generatePersonList(2);

        // set AB state to 2 persons
        model.resetData(new AddressBook());
        for (ToDo p : personList) {
            model.addPerson(p);
        }
    ...
    public void execute_select_jumpsToCorrectPerson() throws Exception {
        TestDataHelper helper = new TestDataHelper();
        List<ToDo> threePersons = helper.generatePersonList(3);
    ...
    public void execute_find_onlyMatchesFullWordsInNames() throws Exception {
        TestDataHelper helper = new TestDataHelper();
        ToDo pTarget1 = helper.generatePersonWithName("bla bla KEY bla");
        ToDo pTarget2 = helper.generatePersonWithName("bla KEY bla bceofeia");
        ToDo p1 = helper.generatePersonWithName("KE Y");
        ToDo p2 = helper.generatePersonWithName("KEYKEYKEY sduauo");

        List<ToDo> fourPersons = helper.generatePersonList(p1, pTarget1, p2, pTarget2);
        AddressBook expectedAB = helper.generateAddressBook(fourPersons);
        List<ToDo> expectedList = helper.generatePersonList(pTarget1, pTarget2);
    ...
    public void execute_find_isNotCaseSensitive() throws Exception {
        TestDataHelper helper = new TestDataHelper();
        ToDo p1 = helper.generatePersonWithName("bla bla KEY bla");
        ToDo p2 = helper.generatePersonWithName("bla KEY bla bceofeia");
        ToDo p3 = helper.generatePersonWithName("key key");
        ToDo p4 = helper.generatePersonWithName("KEy sduauo");

        List<ToDo> fourPersons = helper.generatePersonList(p3, p1, p4, p2);
        AddressBook expectedAB = helper.generateAddressBook(fourPersons);
        List<ToDo> expectedList = fourPersons;
        helper.addToModel(model, fourPersons);
    ...
    public void execute_find_matchesIfAnyKeywordPresent() throws Exception {
        TestDataHelper helper = new TestDataHelper();
        ToDo pTarget1 = helper.generatePersonWithName("bla bla KEY bla");
        ToDo pTarget2 = helper.generatePersonWithName("bla rAnDoM bla bceofeia");
        ToDo pTarget3 = helper.generatePersonWithName("key key");
        ToDo p1 = helper.generatePersonWithName("sduauo");

        List<ToDo> fourPersons = helper.generatePersonList(pTarget1, p1, pTarget2, pTarget3);
        AddressBook expectedAB = helper.generateAddressBook(fourPersons);
        List<ToDo> expectedList = helper.generatePersonList(pTarget1, pTarget2, pTarget3);
        helper.addToModel(model, fourPersons);
    ...
    class TestDataHelper {
         ...
         */
        ToDo generatePerson(int seed) throws Exception {
            return new ToDo(
         ...
         */
        AddressBook generateAddressBook(List<ToDo> persons) throws Exception {
            AddressBook addressBook = new AddressBook();
         ...
         */
        void addToAddressBook(AddressBook addressBook, List<ToDo> personsToAdd) throws Exception {
            for (ToDo p: personsToAdd) {
         ...
         */
        void addToModel(Model model, List<ToDo> personsToAdd) throws Exception {
            for (ToDo p: personsToAdd) {
                model.addPerson(p);
            }
        }
         ...
         */
        List<ToDo> generatePersonList(int numGenerated) throws Exception {
            List<ToDo> persons = new ArrayList<>();
        ...
        List<ToDo> generatePersonList(ToDo... persons) {
         ...
         */
        ToDo generatePersonWithName(String name) throws Exception {
            return new ToDo(
                    new Name(name),
                    new Phone("1"),
                    new Email("1@email"),
