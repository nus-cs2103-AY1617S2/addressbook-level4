...
public class LogicManagerTest {
   ...
   * the result message is correct. Both the 'task manager' and the 'last shown
   ...
   * a CommandException is thrown if expected and also confirms that the
  ...
  public void execute_exit() {
    assertCommandSuccess("exit", ExitCommand.MESSAGE_EXIT_ACKNOWLEDGEMENT, new TaskManager(), Collections.emptyList());
  }
  ...
  private void assertIncorrectIndexFormatBehaviorForCommand(String commandWord, String expectedMessage)
    ...
    assertCommandFailure(commandWord + " +1", expectedMessage); // index should
                                                                // be unsigned
    assertCommandFailure(commandWord + " -1", expectedMessage); // index should
                                                                // be unsigned
    assertCommandFailure(commandWord + " 0", expectedMessage); // index cannot
                                                               // be 0
  ...
  public void execute_find_matchesIfAnyKeywordPresent() throws Exception {
    ...
    assertCommandSuccess("find key rAnDoM", Command.getMessageForTaskListShownSummary(expectedList.size()), expectedTM,
        expectedList);
  }
