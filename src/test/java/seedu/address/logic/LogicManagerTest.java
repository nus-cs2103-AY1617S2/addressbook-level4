...
public class LogicManagerTest {
	...
	public void execute_find_onlyMatchesFullWordsInTags() throws Exception {
		...
		List<Task> sevenTasks = helper.generateTaskList(p1, targetTagAndName1, p2, targetTagAndName2, targetTag1, targetTag2, p3);
	...
	class TestDataHelper {
		...
		/**
		 * Generates a Task object with given name and tag. Other fields will have some
		 * dummy values.
		 */
