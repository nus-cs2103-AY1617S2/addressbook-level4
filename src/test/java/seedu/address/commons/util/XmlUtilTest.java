...
public class XmlUtilTest {
    ...
    public void getDataFromFile_nullFile_AssertionError() throws Exception {
        ...
        XmlUtil.getDataFromFile(null, YTomorrow.class);
    }
    ...
    public void getDataFromFile_missingFile_FileNotFoundException() throws Exception {
        ...
        XmlUtil.getDataFromFile(MISSING_FILE, YTomorrow.class);
    }

    @Test
    public void getDataFromFile_emptyFile_DataFormatMismatchException() throws Exception {
        thrown.expect(JAXBException.class);
        XmlUtil.getDataFromFile(EMPTY_FILE, YTomorrow.class);
    }
    ...
    public void saveDataToFile_nullFile_AssertionError() throws Exception {
        thrown.expect(AssertionError.class);
        XmlUtil.saveDataToFile(null, new YTomorrow());
    }
    ...
    public void saveDataToFile_missingFile_FileNotFoundException() throws Exception {
        thrown.expect(FileNotFoundException.class);
        XmlUtil.saveDataToFile(MISSING_FILE, new YTomorrow());
    }

    @Test
    public void saveDataToFile_validFile_dataSaved() throws Exception {
        TEMP_FILE.createNewFile();
        XmlSerializableTaskManager dataToWrite = new XmlSerializableTaskManager(new YTomorrow());
        XmlUtil.saveDataToFile(TEMP_FILE, dataToWrite);
        XmlSerializableTaskManager dataFromFile = XmlUtil.getDataFromFile(TEMP_FILE, XmlSerializableTaskManager.class);
        assertEquals((new YTomorrow(dataToWrite)).toString(), (new YTomorrow(dataFromFile)).toString());
        //TODO: use equality instead of string comparisons

        AddressBookBuilder builder = new AddressBookBuilder(new YTomorrow());
