        ...
        try {
            ...
            return new Task[] {
                new Task(new Title("CS2103 Tutorial"), new Venue("COM1-B103"), new StartTime("Tuesday 10:00"),
                        new EndTime("Tuesday 11:00"), new UrgencyLevel("3"), new Description("Deadline of V0.2"), new UniqueTagList()),
                new Task(new Title("DBS Internship interview"), new Venue("Raffles Place"), new StartTime("March 31, 9:30"),
                        new EndTime("Wednesday 12:00"), new UrgencyLevel("3"), new Description("I love interview"), new UniqueTagList()),
                new Task(new Title("Hang out with Joe"), new Venue("313 Somerset"), new StartTime("Saturday 11:00"),
                        new EndTime("Saturday 17:00"), new UrgencyLevel("3"), new Description("I love Joe"), new UniqueTagList()),
                ...
                new Task(new Title("Tuition part-time job"), new Venue("Jun Wei's house at Jurong Ease Avenue 1"), new StartTime("Next Thursday 19:00"),
                        new EndTime("Thursday 21:00"), new UrgencyLevel("3"), new Description("I love Part-time"), new UniqueTagList()),
                new Task(new Title("Strings ensemble rehearsal"), new Venue("UCC hall"), new StartTime("Friday 9:00"),
                        new EndTime("Friday 17:00"), new UrgencyLevel("3"), new Description("I love rehearsal"), new UniqueTagList()),
                new Task(new Title("Dinner with auntie"), new Venue("Home"), new StartTime("Friday 19:00"),
                        new EndTime("Friday 20:00"), new UrgencyLevel("3"), new Description("I love auntie"), new UniqueTagList()),
                ...
                new Task(new Title("Submit FIN3101 Tutorial"), new Venue("Biz1-0748 Prof Tan's office"), new StartTime("now"),
                        new EndTime("Thursday 11am"), new UrgencyLevel("3"), new Description("I love fanbingbing"), new UniqueTagList()) };
