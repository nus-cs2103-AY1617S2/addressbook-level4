...
public class TestUtil {
	...
	private static Task[] getSampleTaskData() {
		try {
			...
			return new Task[] {
					new Task(new Name("Ali Muster"), new Priority("9482424"), new Deadline("hans@google.com"),
							new Description("4th street"), new UniqueTagList()),
					new Task(new Name("Boris Mueller"), new Priority("87249245"), new Deadline("ruth@google.com"),
							new Description("81th street"), new UniqueTagList()),
					new Task(new Name("Carl Kurz"), new Priority("95352563"), new Deadline("heinz@yahoo.com"),
							new Description("wall street"), new UniqueTagList()),
					new Task(new Name("Daniel Meier"), new Priority("87652533"), new Deadline("cornelia@google.com"),
							new Description("10th street"), new UniqueTagList()),
					new Task(new Name("Elle Meyer"), new Priority("9482224"), new Deadline("werner@gmail.com"),
							new Description("michegan ave"), new UniqueTagList()),
					new Task(new Name("Fiona Kunz"), new Priority("9482427"), new Deadline("lydia@gmail.com"),
							new Description("little tokyo"), new UniqueTagList()),
					new Task(new Name("George Best"), new Priority("9482442"), new Deadline("anna@google.com"),
							new Description("4th street"), new UniqueTagList()),
					new Task(new Name("Hoon Meier"), new Priority("8482424"), new Deadline("stefan@mail.com"),
							new Description("little india"), new UniqueTagList()),
					new Task(new Name("Ida Mueller"), new Priority("8482131"), new Deadline("hans@google.com"),
