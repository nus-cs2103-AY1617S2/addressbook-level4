...
public class TestUtil {
    ...
    private static Task[] getSamplePersonData() {
        try {
            ...
            return new Task[]{
                new Task(new Description("Ali Muster"), new Priority("9482424"), new Email("hans@google.com"),  new UniqueTagList()),
                new Task(new Description("Boris Mueller"), new Priority("87249245"), new Email("ruth@google.com"), new UniqueTagList()),
                new Task(new Description("Carl Kurz"), new Priority("95352563"), new Email("heinz@yahoo.com"), new UniqueTagList()),
                new Task(new Description("Daniel Meier"), new Priority("87652533"), new Email("cornelia@google.com"), new UniqueTagList()),
                new Task(new Description("Elle Meyer"), new Priority("9482224"), new Email("werner@gmail.com"), new UniqueTagList()),
                new Task(new Description("Fiona Kunz"), new Priority("9482427"), new Email("lydia@gmail.com"), new UniqueTagList()),
                new Task(new Description("George Best"), new Priority("9482442"), new Email("anna@google.com"), new UniqueTagList()),
                new Task(new Description("Hoon Meier"), new Priority("8482424"), new Email("stefan@mail.com"), new UniqueTagList()),
                new Task(new Description("Ida Mueller"), new Priority("8482131"), new Email("hans@google.com"), new UniqueTagList())
            };
