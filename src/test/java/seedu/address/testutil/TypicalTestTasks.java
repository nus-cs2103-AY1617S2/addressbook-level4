    ...
    public TypicalTestTasks() {
        try {
            ...
            DBS_Interview = new TaskBuilder().withTitle("DBS Internship interview").withVenue("Raffles Place")
                    ...
                    .withTags("interview", "internship","important").withUrgencyLevel("5").withDescription("I love you").build();
            Hang_out_Joe = new TaskBuilder().withTitle("Hang out with Joe").withVenue("313 Somerset")
                    .withStartTime("Saturday 17:00").withEndTime("Saturday 21:00").withUrgencyLevel("4").withDescription("I love you").build();
            Stats_soc = new TaskBuilder().withTitle("Statistics society meeting").withVenue("S16 04-30")
                    .withStartTime("Wednesday 19:00").withEndTime("Wednesday 21:00").withUrgencyLevel("4").withDescription("I love you").build();
            Tuition_part_time = new TaskBuilder().withTitle("Tuition part-time job").withVenue("Jun Wei's house at Jurong Ease Avenue 1")
                    .withStartTime("Next Thursday 19:00").withEndTime("Next Thursday 21:00").withUrgencyLevel("4").withDescription("I love you").build();
            Strings_rehearsal = new TaskBuilder().withTitle("Strings ensemble rehearsal").withVenue("UCC hall")
                    .withStartTime("Friday 9:00").withEndTime("Friday 18:00").withUrgencyLevel("3").withDescription("I love you").build();
            dinner_auntie = new TaskBuilder().withTitle("Dinner with auntie").withVenue("Home")
                    .withStartTime("Friday 19:00").withEndTime("Friday 20:00").withUrgencyLevel("2").withDescription("I love you").build();

            // Manually added
            MA3269_Quiz = new TaskBuilder().withTitle("MA3269 Quiz").withVenue("LT26")
                    .withStartTime("Thursday 12:00").withEndTime("Thursday 14:00").withUrgencyLevel("1").withDescription("I love you").build();
            laundry = new TaskBuilder().withTitle("Do laundry").withVenue("Hostel")
                    .withStartTime("now").withEndTime("1 hour later chores").withUrgencyLevel("1").withDescription("I love you").build();
