...
public class TypicalTestTasks {
    ...
    public TestTask alice, benson, carl, daniel, elle, fiona, george, hoon, ida, taskWithotPriority;
    ...
    public TypicalTestTasks() {
        try {
            ...
            taskWithotPriority = new TaskBuilder().withName("Submit research proposal")
