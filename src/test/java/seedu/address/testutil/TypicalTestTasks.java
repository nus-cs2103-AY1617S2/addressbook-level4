    ...
    public TypicalTestTasks() {
        try {
            ...
            task6 = new TaskBuilder().withTitle("Complete task 6").withStartTime("10-10-2017 0100")
                    .withDeadline("10-11-2017").withStatus(false).build();
