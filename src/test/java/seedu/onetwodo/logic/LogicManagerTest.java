...
public class LogicManagerTest {
    ...
    @Subscribe
    private void handleShowHelpUGRequestEvent(ShowHelpRequestEvent she) {
        helpShown = true;
    }
     ...
     * that the result message is correct. Also confirms that both the 'toDo
     ...
     * the result message is correct. Both the 'toDo List' and the 'last shown
    ...
    public void execute_add_invalidArgsFormat() {
        ...
        /*
         * assertCommandFailure("add Valid Name 12345 e/tomorrow 5pm e/tomorrow 6pm d/many EndDate"
         * , expectedMessage);
         * assertCommandFailure("add Valid Name d/more than one description d/more description"
         * , expectedMessage);
         * assertCommandFailure("add Valid Name s/tomorrow s/tomorrow e/tomorrow d/too much StartDate"
         * , expectedMessage);
         */
    }
    ...
    public void execute_add_invalidTaskData() {
        assertCommandFailure("add []\\[;] s/today e/tomorrow d/valid, address", Name.MESSAGE_NAME_CONSTRAINTS);
        ...
        assertCommandFailure("add Valid Name e/tomorrow r/dailyyyy d/valid", Recurring.RECURRING_CONSTRAINTS);
        String result = TaskAttributesChecker.MESSAGE_INVALID_RECUR + AddCommand.MESSAGE_USAGE;
        assertCommandFailure("add Valid Name r/daily d/no date", String.format(MESSAGE_INVALID_COMMAND_FORMAT, result));
    ...
    public void execute_list_showsAllTasks() throws Exception {
        ...
        assertCommandSuccess("list", ListCommand.MESSAGE_LIST_UNDONE_SUCCESS, expectedAB, expectedList);
    }
    ...
    public void execute_selectInvalidArgsFormat_errorMessageShown() throws Exception {
        ...
        // assertIncorrectIndexFormatBehaviorForCommand("select z1",
        // expectedMessage);
        // assertIncorrectIndexFormatBehaviorForCommand("select 65868434",
        // expectedMessage);
    ...
    public void execute_select_jumpsToCorrectTask() throws Exception {
        ...
        assertCommandSuccess("select e2", String.format(SelectCommand.MESSAGE_SELECT_TASK_SUCCESS, "E2"), expectedAB,
    ...
    public void execute_delete_removesCorrectTask() throws Exception {
        ...
        assertCommandSuccess("delete e2",
                String.format(DeleteCommand.MESSAGE_DELETE_TASK_SUCCESS, threeEventTasks.get(1)), expectedAB,
                expectedAB.getTaskList());
    }
