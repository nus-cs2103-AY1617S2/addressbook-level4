    ...
    public TypicalTestEvents() {
        try {
            abdicate = new EventBuilder().withTitle("Abdicate the British Throne")
                    .withDescription("caught having a mistress").withStartTime("7:00am")
                    .withEndTime("9:00am").withLocation("Buckingham Palace").withPeriodic("none")
                    .withTags("KingGeorgeVI").build();
            boop = new EventBuilder().withTitle("Boop")
                    .withDescription("Boop that nose").withStartTime("1:00am")
                    .withEndTime("2:00am").withLocation("King's Row").withPeriodic("daily")
         ...
         // Manually added
            ...
            duck = new EventBuilder().withTitle("ahhhh")
                    .withDescription("AHHHHHHHHH").withStartTime("9:00pm")
                    .withEndTime("10:00pm").withLocation("AHHH").withPeriodic("none")
                    .withTags("AHHHHHHHHHHHHHH").build();
