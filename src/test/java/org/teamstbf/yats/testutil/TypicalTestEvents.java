...
public class TypicalTestEvents {
    ...
    public TestEvent abdicate, boop, oxygen, cower, duck, fish, goon, scheduleChecker, sameDayScheduleChecker,
            nextDayScheduleChecker;
    ...
    public TypicalTestEvents() {
        try {
            ...
            oxygen = new EventBuilder().withTitle("Oxygen not Included").withDescription("Don't starve together")
                    ...
                    .withLocation("Klei Entertainment").withTags("ONN").withIsDone("No")
            ...
            cower = new EventBuilder().withTitle("Act like a craven")
                    ...
                    .withTags("LordCommanderJonSnow").withIsDone("No").withRecurrence(new Recurrence()).build();
            ...
            goon = new EventBuilder().withTitle("du").withDescription("").withStartTime("").withEndTime("")
                    ...
                    .withRecurrence(new Recurrence()).build();
            sameDayScheduleChecker = new EventBuilder().withTitle("sameDayScheduler").withDescription("")
                    .withStartTime("12:00PM 08/04/2023").withEndTime("").withDeadline("").withLocation("home")
                    .withHours("4").withMinutes("4").withIsDone("No").withRecurrence(new Recurrence()).build();
            nextDayScheduleChecker = new EventBuilder().withTitle("nextDayScheduler").withDescription("")
                    .withStartTime("8:00AM 08/04/2023").withEndTime("").withDeadline("").withLocation("").withHours("8")
                    .withMinutes("8").withIsDone("No").withRecurrence(new Recurrence()).build();
