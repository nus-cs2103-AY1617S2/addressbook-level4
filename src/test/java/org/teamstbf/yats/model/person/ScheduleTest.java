...
public class ScheduleTest {
	...
	/*
	 * @Test public void test() { // invalid schedule
	 ...
	 * characters assertFalse(Schedule.isValidSchedule("f3vbt5b5")); // invalid
	 * input assertFalse(Schedule.isValidSchedule("05/05/2017 12:00PM")); //
	 * date before time
	 * assertFalse(Schedule.isValidSchedule("13:00AM 05/05/2017")); // wrong
	 * time assertFalse(Schedule.isValidSchedule("12:65AM 05/05/2017")); //
	 * wrong time assertFalse(Schedule.isValidSchedule("13:00ZM 05/05/2017"));
	 * // wrong time
	 * assertFalse(Schedule.isValidSchedule("12:00AM 43/05/2017")); // wrong
	 * date assertFalse(Schedule.isValidSchedule("12:00AM 05/00/2017")); //
	 * wrong date assertFalse(Schedule.isValidSchedule("12:00AM 05/13/2017"));
	 * // wrong date
	 * assertFalse(Schedule.isValidSchedule("14:00AM 43/05/2017")); // wrong
	 * time and date
	 * 
	 * // valid schedule
	 * assertTrue(Schedule.isValidSchedule("12:00AM 05/05/2017"));
