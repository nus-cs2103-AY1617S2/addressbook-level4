...
public class LogicManagerTest {
    ...
    public void execute_add_invalidEventData() {
        ...
        // assertCommandFailure("add Valid Name -s 5 may 2017 13:00AM -e 6 may
        // 2017 14:00PM", Schedule.MESSAGE_TIME_CONSTRAINTS);
    ...
    public void execute_add_successful() throws Exception {
        ...
        assertCommandSuccess(
                "add sleep -l bed -s 26 june 2017 12:00AM -e 27 june 2017 11:00AM"
                        + " -d finals finally over -T rest -T moreRest",
    ...
    public void execute_select_jumpsToCorrectEvent() throws Exception {
        ...
        assertCommandSuccess("select 2", String.format(SelectCommand.MESSAGE_SELECT_PERSON_SUCCESS, threeEvents.get(1)),
                expectedAB, expectedAB.getTaskList());
