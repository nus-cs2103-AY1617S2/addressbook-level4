...
//                && getTaskDate().toString().equals(task.getTaskDate().toString())
//                && getTaskStartTime().toString().equals(task.getTaskStartTime().toString())
//                && getTaskEndTime().toString().equals(task.getTaskEndTime().toString())
