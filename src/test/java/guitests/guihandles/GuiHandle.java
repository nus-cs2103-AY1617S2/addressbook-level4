...
// /**
// * An optional stage that exists in the App other than the primaryStage, could
// be a alert dialog, popup window, etc.
// */
...
// .stream()
// .filter(w -> w instanceof Stage && ((Stage)
// w).getTitle().equals(stageTitle)).findAny();
//
// if (!window.isPresent()) {
// logger.warning("Can't find stage " + stageTitle + ", Therefore, aborting
// focusing");
// return;
// }
...
// return ((Label)
// guiRobot.from(parentNode).lookup(fieldId).tryQuery().get()).getText();
// }
//
