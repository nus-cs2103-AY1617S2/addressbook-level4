...
public class TaskListPanelHandle extends GuiHandle {
    ...
    /**
     * Returns true if the {@code tasks} appear as the sub list (in that
    ...
    public boolean containsInOrder(int startPosition, ReadOnlyTask... tasks) {
        ...
        for (int i = 0; i < tasks.length; i++) {
            if (!tasksInList.get(startPosition + i).getTaskName().fullName
                    .equals(tasks[i].getTaskName().fullName)) {
                return false;
            }
        }
