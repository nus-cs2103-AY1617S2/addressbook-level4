...
public class TaskListPanelHandle extends GuiHandle {
  ...
  /**
   * Returns true if the {@code tasks} appear as the sub list (in that order) at
   * position {@code startPosition}.
   */
  ...
  public TaskCardHandle navigateToTask(String name) {
    ...
    final Optional<ReadOnlyTask> task = getListView().getItems().stream().filter(p -> p.getName().fullName.equals(name))
        .findAny();
    if (!task.isPresent()) {
