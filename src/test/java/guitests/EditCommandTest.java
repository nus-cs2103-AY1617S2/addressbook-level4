...
public class EditCommandTest extends AddressBookGuiTest {
    ...
    public void edit_allFieldsSpecified_success() throws Exception {
        ...
        TestTask editedPerson = new TaskBuilder().withName("Bobby")
                .withAddress("Block 123, Bobby Street 3").withLabels("husband").build();
    ...
    private void assertEditSuccess(int filteredPersonListIndex, int addressBookIndex,
        ...
        PersonCardHandle editedCard = personListPanel.navigateToPerson(editedPerson.getTitle().title);
