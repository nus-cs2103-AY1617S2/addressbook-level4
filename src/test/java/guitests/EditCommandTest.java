...
public class EditCommandTest extends TaskManagerGuiTest {
	...
	public void edit_allFieldsSpecified_success() throws Exception {
		...
		TestEvent editedPerson = new EventBuilder().withTitle("Bobby").withLocation("Block 123, Bobby Street 3")
				.withPeriodic("daily").withStartTime("7:00am").withEndTime("9:00am").withDescription("husband")
				.withTags("nil").build();
