...
public class EditCommandTest extends TaskManagerGuiTest {
    ...
    public void edit_allFieldsSpecified_success() throws Exception {
        ...
        TestTask editedTask = new TaskBuilder().withName("Create a google doc").withPriority("low")
                .withStatus("incomplete").withNote("For our project proposal").withDateTime("12/12/2017 12:00").build();
    ...
    public void edit_duplicateTask_failure() {
        commandBox.runCommand("edit 3 Do laundry p/hi s/incomplete "
                                + "n/Twice as many detergent this time d/12/12/2017 12:00 t/chores");
