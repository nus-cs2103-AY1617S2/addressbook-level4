...
//        String detailsToEdit = "CS1010 start/10/03/17 15:00 end/10/03/17 16:00 desc/revision for final tag/tutorial";
//        int taskBookIndex = 1;
//
//        TestTask editedTask = new TaskBuilder().withName("CS1010").withStartTime("10/03/17 15:00")
//                .withEndTime("10/03/17 16:00").withDescription("revision for final").withTags("tutorial").build();
//
...
//        commandBox.runCommand("edit 3 CS3101 start/10/03/17 15:00 end/10/03/17 17:00 "
