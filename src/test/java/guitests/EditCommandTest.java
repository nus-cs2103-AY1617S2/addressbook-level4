...
public class EditCommandTest extends ToDoListGuiTest {
    ...
    public void edit_allFieldsSpecified_success() throws Exception {
        ...
        assertEditSuccess(ToDoListIndex, ToDoListIndex, detailsToEdit, editedPerson);
    }
    ...
    public void edit_notAllFieldsSpecified_success() throws Exception {
        ...
        TestPerson personToEdit = expectedPersonsList[ToDoListIndex - 1];
     ...
     */
    private void assertEditSuccess(int filteredPersonListIndex, int ToDoListIndex,
        ...
        expectedPersonsList[ToDoListIndex - 1] = editedPerson;
