...
public class EditCommandTest extends TaskManagerGuiTest {
    ...
    public void edit_allFieldsSpecified_success() throws Exception {
        String detailsToEdit = "Task1 d/000000 p/1 i/Block 123, Bobby Street 3 t/husband";
        int addressBookIndex = 1;

        TestTask editedTask = new TaskBuilder().withName("Task1").withDeadline("000000")
    ...
    public void edit_duplicateTask_failure() {
        commandBox.runCommand("edit 3 Task1 d/111111 p/1 i/Information 1 t/friends");
