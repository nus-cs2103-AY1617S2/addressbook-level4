...
public class DeleteCommandTest extends AddressBookGuiTest {
    ...
    // TestPerson personToDelete = currentList[targetIndexOneIndexed - 1]; // -1
    // as array uses zero indexing
    // TestPerson[] expectedRemainder =
    // TestUtil.removePersonFromList(currentList, targetIndexOneIndexed);
    //
