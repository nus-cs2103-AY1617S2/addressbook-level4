...
public class AddTaskCommandTest extends ToLuistGuiTest {
    ...
    public void addFloatingTask() {
        ...
        runCommandWithCallback(command2, () -> assertTasksShown(true, task, task2));
    }
    ...
    public void addTaskWithDeadline() {
        ...
        String taskDescription2 = StringUtil.EMPTY_STRING;
        ...
        runCommandWithCallback(command3, () -> assertTasksShown(true, task1, task3));
    }
    ...
    public void addEvent() {
        ...
        String taskDescription3 = StringUtil.EMPTY_STRING;
        ...
        runCommandWithCallback(command4, () -> assertTasksShown(true, task1, task4));
    }
    ...
    public void addTaskWithInvalidPriorityLevel_shouldNotBeCreated() {
        ...
        priorityString = StringUtil.EMPTY_STRING;
    ...
    public void addRecurringFloatingTask() {
        ...
        runCommandWithCallback(command, () -> assertTasksShown(true, task1, task2));
    }
    ...
    public void addRecurringTaskWithWrongParams_shouldThrowException() {
        ...
        String recurFrequencyString = StringUtil.EMPTY_STRING;
        String command = ADD + taskDescription + REPEAT + recurFrequencyString
                + FROM + from + TO + to;
        Task task = null;
        try {
