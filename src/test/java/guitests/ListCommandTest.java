...
public class ListCommandTest extends TaskManagerGuiTest {
    ...
    public void list_nonEmptyList() {
        ...
        commandBox.runCommand("list");
        assertListResult("list by start", td.scheduleChecker, td.abdicate, td.oxygen, td.cower, td.boop, td.duck);
        ...
        commandBox.runCommand("list");
        assertListResult("list by deadline", td.boop, td.duck, td.abdicate, td.oxygen, td.cower, td.scheduleChecker);
    }
