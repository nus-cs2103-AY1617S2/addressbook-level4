# A0135998H
###### /java/onlythree/imanager/commons/events/model/ViewListChangedEvent.java
``` java
...
```
###### /java/onlythree/imanager/logic/commands/DoneCommand.java
``` java
/**
...
```
###### /java/onlythree/imanager/logic/commands/ViewCommand.java
``` java
/**
...
```
###### /java/onlythree/imanager/logic/parser/DoneCommandParser.java
``` java
/**
...
```
###### /java/onlythree/imanager/logic/parser/ViewCommandParser.java
``` java
/**
...
```
###### /java/onlythree/imanager/ui/Clock.java
``` java
...
```
###### /java/onlythree/imanager/ui/MainWindow.java
``` java
/**
...
```
###### /java/onlythree/imanager/ui/TaskCard.java
``` java
...
```
###### /java/onlythree/imanager/ui/TaskListPanel.java
``` java
/**
...
```
###### /java/onlythree/imanager/ui/TaskTabPanel.java
``` java
...
```
###### /java/onlythree/imanager/ui/UiManager.java
``` java
    @Subscribe
...
<HBox id="cardPane" fx:id="cardPane" prefHeight="79.0" prefWidth="517.0" xmlns="http://javafx.com/javafx/8.0.111" xmlns:fx="http://javafx.com/fxml/1">
   <children>
      ...
      <StackPane prefHeight="78.0" prefWidth="346.0" HBox.hgrow="ALWAYS">
         <children>
            <HBox fx:id="startEndDateContainer" prefHeight="100.0" prefWidth="268.0">
               <children>
