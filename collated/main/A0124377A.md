...
```
###### /java/seedu/address/commons/events/ui/JumpToCalendarEventEvent.java
``` java
/**
...
```
###### /java/seedu/address/commons/events/ui/JumpToCalendarTaskEvent.java
``` java
/**
...
```
###### /java/seedu/address/logic/commands/CalendarRefreshCommand.java
``` java
/**
...
```
###### /java/seedu/address/logic/parser/CalendarViewCommandParser.java
``` java
      ...
      <SplitPane id="splitPane" fx:id="splitPane" dividerPositions="0.3" VBox.vgrow="ALWAYS">
         <items>
           <SplitPane dividerPositions="0.3" orientation="VERTICAL">
            <items>
                <VBox fx:id="eventList" minWidth="50.0" prefWidth="50.0" alignment="CENTER_LEFT">
                    <padding>
           ...
           <VBox fx:id="extended" minWidth="700.0" prefWidth="700.0">
                <padding>
