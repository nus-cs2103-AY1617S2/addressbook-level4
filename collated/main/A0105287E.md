...
public class MarkCommand extends Command {
    ...
    private static Task createEditedTask(ReadOnlyTask taskToEdit, Boolean isCompleted)
        ...
        updatedStartTime = Optional.of(new Deadline(taskToEdit.getStartTime().get().toString()));
        updatedDeadline = Optional.of(new Deadline (taskToEdit.getDeadline().get().toString()));
        UniqueLabelList updatedLabels = new UniqueLabelList (taskToEdit.getLabels());
        Boolean isRecurring = new Boolean (taskToEdit.isRecurring());
        Optional<Recurrence> updatedRecurrence = Optional.of(new Recurrence(taskToEdit.getRecurrence()
                                                        .get().toString()));
