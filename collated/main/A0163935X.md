...
public class CalenderPanel extends UiPart<Region> {
    ...
    private void setDate(int dDate, int dMonth, int dYear) {
        ...
        if ("??Ÿæ?Ÿä?".equals(dayOfTheWeek) || "Monday".equals(dayOfTheWeek)) {
            firstDay.add(Calendar.DATE, -1);
        } else if ("??Ÿæ?Ÿä??".equals(dayOfTheWeek) || "Tuesday".equals(dayOfTheWeek)) {
            firstDay.add(Calendar.DATE, -2);
        } else if ("??Ÿæ?Ÿä??".equals(dayOfTheWeek) || "Wednesday".equals(dayOfTheWeek)) {
            firstDay.add(Calendar.DATE, -3);
        } else if ("??Ÿæ?Ÿå??".equals(dayOfTheWeek) || "Thursday".equals(dayOfTheWeek)) {
            firstDay.add(Calendar.DATE, -4);
        } else if ("??Ÿæ?Ÿä??".equals(dayOfTheWeek) || "Friday".equals(dayOfTheWeek)) {
            firstDay.add(Calendar.DATE, -5);
        } else if ("??Ÿæ?Ÿå…­".equals(dayOfTheWeek) || "Saturday".equals(dayOfTheWeek)) {
