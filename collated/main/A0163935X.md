...
public class CalenderPanel extends UiPart<Region> {
    ...
    private void setDate(int dDate, int dMonth, int dYear) {
        ...
        if ("??æ?ä?".equals(dayOfTheWeek) || "Monday".equals(dayOfTheWeek)) {
            firstDay.add(Calendar.DATE, -1);
        } else if ("??æ?ä??".equals(dayOfTheWeek) || "Tuesday".equals(dayOfTheWeek)) {
            firstDay.add(Calendar.DATE, -2);
        } else if ("??æ?ä??".equals(dayOfTheWeek) || "Wednesday".equals(dayOfTheWeek)) {
            firstDay.add(Calendar.DATE, -3);
        } else if ("??æ?å??".equals(dayOfTheWeek) || "Thursday".equals(dayOfTheWeek)) {
            firstDay.add(Calendar.DATE, -4);
        } else if ("??æ?ä??".equals(dayOfTheWeek) || "Friday".equals(dayOfTheWeek)) {
            firstDay.add(Calendar.DATE, -5);
        } else if ("??æ?å­".equals(dayOfTheWeek) || "Saturday".equals(dayOfTheWeek)) {
