# A0115959R
###### /java/seedu/bulletjournal/logic/commands/ChangePathCommand.java
``` java
...
```
###### /java/seedu/bulletjournal/logic/parser/ChangePathCommandParser.java
``` java
...
```
###### /java/seedu/bulletjournal/logic/parser/Parser.java
``` java
package seedu.bulletjournal.logic.parser;
