# A0148038A
###### \main\java\seedu\address\commons\events\ui\EventPanelSelectionChangedEvent.java
``` java
/**
...
```
###### \main\java\seedu\address\commons\events\ui\JumpToEventListRequestEvent.java
``` java
/**
...
```
###### \main\java\seedu\address\commons\events\ui\JumpToTaskListRequestEvent.java
``` java
/**
...
```
###### \main\java\seedu\address\commons\events\ui\TaskPanelSelectionChangedEvent.java
``` java
/**
...
```
###### \main\java\seedu\address\model\person\ByDate.java
``` java
...
```
###### \main\java\seedu\address\model\person\ByTime.java
``` java
...
```
###### \main\java\seedu\address\model\person\EndDate.java
``` java
/**
...
```
###### \main\java\seedu\address\model\person\EndTime.java
``` java
/**
...
```
###### \main\java\seedu\address\model\person\Event.java
``` java
/**
...
```
###### \main\java\seedu\address\model\person\Location.java
``` java
/**
...
```
###### \main\java\seedu\address\model\person\Priority.java
``` java
/**
...
```
###### \main\java\seedu\address\model\person\ReadOnlyEvent.java
``` java
/**
...
```
###### \main\java\seedu\address\model\person\ReadOnlyTask.java
``` java
...
```
###### \main\java\seedu\address\model\person\StartDate.java
``` java
/**
...
```
###### \main\java\seedu\address\model\person\StartTime.java
``` java
/**
...
```
###### \main\java\seedu\address\model\person\UniqueEventList.java
``` java
    /**
...
```
###### \main\java\seedu\address\model\person\UniqueTaskList.java
``` java
    /**
     * Updates an event in WhatsLeft.
     *
...
```
###### \main\java\seedu\address\model\util\SampleDataUtil.java
``` java
...
```
###### \main\java\seedu\address\model\WhatsLeft.java
``` java
    /**
...
```
###### \main\java\seedu\address\ui\EventCard.java
``` java
...
```
###### \main\java\seedu\address\ui\EventListPanel.java
``` java
/**
...
```
###### \main\java\seedu\address\ui\TaskCard.java
``` java
...
```
###### \main\java\seedu\address\ui\TaskListPanel.java
``` java
/**
 * Panel containing the list of activities.
 */
...
```
###### \main\resources\view\EventListCard.fxml
``` fxml
...
```
###### \main\resources\view\EventListPanel.fxml
``` fxml
...
```
###### \main\resources\view\ResultDisplay.fxml
``` fxml
...
```
###### \test\java\seedu\address\model\person\LocationTest.java
``` java
