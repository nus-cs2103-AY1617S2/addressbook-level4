...
```
###### /java/seedu/doit/ui/HelpWindow.java
``` java
/**
...
.anchor-pane-with-border {
    -fx-background-color: derive(#e2e8e4, 20%);
    -fx-border-color: derive(#002c54, 10%);
...
<VBox xmlns="http://javafx.com/javafx/8" xmlns:fx="http://javafx.com/fxml/1">
    ...
    <children>
      <HBox prefHeight="20.0" prefWidth="200.0">
         <children>
            <TextField alignment="CENTER" editable="false" prefHeight="36.0" prefWidth="340.0" styleClass="text-header" text="EVENT" HBox.hgrow="ALWAYS">
            </TextField>
         </children>
      </HBox>
      <ListView fx:id="eventListView" Style="-fx-background-color:#6eb5c0" prefWidth="340.0" VBox.vgrow="ALWAYS" />
    </children>
</VBox>
```
...
<VBox xmlns="http://javafx.com/javafx/8" xmlns:fx="http://javafx.com/fxml/1">
    ...
    <children>
       <HBox prefHeight="20.0" prefWidth="200.0">
         <children>
            <TextField alignment="CENTER" editable="false" prefHeight="36.0" prefWidth="340.0" styleClass="text-header" text="ANYTIME" HBox.hgrow="ALWAYS">
            </TextField>
         </children>
      </HBox>
        <ListView fx:id="floatingTaskListView" Style="-fx-background-color:#ff9966" prefWidth="340.0" VBox.vgrow="ALWAYS" />
    </children>
</VBox>
```
...
<AnchorPane fx:id="helpWindowRoot" styleClass="pane" stylesheets="@HelpWindow.css" AnchorPane.bottomAnchor="0.0" AnchorPane.leftAnchor="0.0" AnchorPane.rightAnchor="0.0" AnchorPane.topAnchor="0.0" xmlns="http://javafx.com/javafx/8" xmlns:fx="http://javafx.com/fxml/1">
   <children>
      <TableView fx:id="commandTable" styleClass="pane" AnchorPane.bottomAnchor="0.0" AnchorPane.leftAnchor="0.0" AnchorPane.rightAnchor="0.0" AnchorPane.topAnchor="48.0">
        <columns>
          ...
          <TableColumn fx:id="parameterColumn" text="Parameter" />
...
<VBox xmlns="http://javafx.com/javafx/8" xmlns:fx="http://javafx.com/fxml/1">
    ...
    <children>
       <HBox prefHeight="20.0" prefWidth="200.0">
         <children>
            <TextField alignment="CENTER" editable="false" prefHeight="36.0" prefWidth="340.0" styleClass="text-header" text="DEADLINE" HBox.hgrow="ALWAYS">
            </TextField>
         </children>
      </HBox>
        <ListView fx:id="taskListView" Style="-fx-background-color: #002c54" prefWidth="340.0" VBox.vgrow="ALWAYS" />
    </children>
</VBox>
```
