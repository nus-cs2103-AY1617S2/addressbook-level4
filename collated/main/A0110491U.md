...
```
###### \main\java\seedu\address\logic\commands\SelectCommand.java
``` java
...
```
###### \main\java\seedu\address\logic\parser\SelectCommandParser.java
``` java
    /**
...
```
###### \test\java\seedu\address\model\person\ByDateTest.java
``` java
    @Test
...
```
###### \test\java\seedu\address\model\person\ByTimeTest.java
``` java
    @Test
...
```
###### \test\java\seedu\address\model\person\EndDateTest.java
``` java
    @Test
    public void isValidFromDate() {
        //invalid day
...
```
###### \test\java\seedu\address\model\person\EndTimeTest.java
``` java
    @Test
    public void isValidStartTime() {
        //above the threshold of 2400
...
```
###### \test\java\seedu\address\model\person\PriorityTest.java
``` java
    @Test
...
```
###### \test\java\seedu\address\model\person\StartDateTest.java
``` java
    @Test
...
```
###### \test\java\seedu\address\model\person\StartTimeTest.java
``` java
    @Test
    public void isValidStartTime() {
        //above the threshold of 2400
